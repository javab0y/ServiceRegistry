...
public class ServiceRegistryApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(ServiceRegistryApp.class);

    private final Environment env;

    public ServiceRegistryApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ServiceRegistryApp.class);
